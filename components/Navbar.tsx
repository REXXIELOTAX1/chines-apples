...
import { Phone, ShoppingCart, Menu, X, Instagram, MessageCircle } from 'lucide-react';
            ...
            <div className="flex items-center gap-2.5 md:gap-3">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 ml-1">
                <a
                  ...
                  className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-white/5 border border-brand-green/30 flex items-center justify-center text-brand-green hover:bg-brand-green/10 hover:border-brand-green transition-colors"
                >
                ...
                <a
                  ...
                  className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-white/5 border border-brand-green/30 flex items-center justify-center text-brand-green hover:bg-brand-green/10 hover:border-brand-green transition-colors"
                >
                  <TikTokIcon size={12} className="sm:w-[14px] sm:h-[14px]" />
                </a>
                <a
                  href="https://wa.me/2348109377558"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-white/5 border border-brand-green/30 flex items-center justify-center text-brand-green hover:bg-brand-green/10 hover:border-brand-green transition-colors"
