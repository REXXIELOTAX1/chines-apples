      ...
      <div className="bg-brand-dark py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h1 className="font-syne text-4xl md:text-5xl font-bold text-white mb-4">
            Consoles & <span className="text-brand-green">Games</span>
          </h1>
          <p className="text-gray-400 text-lg">
            Explore our collection of genuine gaming consoles and accessories at the best prices in Enugu.
          </p>
        </div>
      </div>
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-4 py-12 md:py-16">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg">No matching games found.</p>
          </div>
        )}
      </div>
